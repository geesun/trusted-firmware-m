...
#This file gathers all Nuvoton/M2351 specific files in the application.

#Nuvoton/M2351 has a Cortex M23 CPU.
...
set (FLASH_LAYOUT          "${PLATFORM_DIR}/target/Nuvoton/M2351/partition/flash_layout.h")
set (PLATFORM_LINK_INCLUDES "${PLATFORM_DIR}/target/Nuvoton/M2351/partition/")
...
embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton/M2351" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton/M2351/cmsis_core" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton/M2351/retarget" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton/M2351/partition" ABSOLUTE)

#Gather all source files we need.
if (NOT DEFINED BUILD_CMSIS_CORE)
  message(FATAL_ERROR "Configuration variable BUILD_CMSIS_CORE (true|false) is undefined!")
elseif(BUILD_CMSIS_CORE)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/cmsis_core/system_cmsdk_nuvoton_m2351.c")
endif()
...
elseif(BUILD_RETARGET)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/retarget/platform_retarget_dev.c")
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/retarget_lcd/ili9341.c")
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/retarget_lcd/font.c")
endif()
...
elseif(BUILD_UART_STDOUT)
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/retarget_lcd/lcd_stdout.c")
...
elseif(BUILD_NATIVE_DRIVERS)
  #list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/arm_uart_drv.c")
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/fmc.c"
                        "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/spi.c" 
                        "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/clk.c" )

  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/mpc_sie200_drv.c"
              "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/ppc_sse200_drv.c"
              )
endif()
...
elseif(BUILD_TIME)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/timer_cmsdk/timer_cmsdk.c")
  embedded_include_directories(PATH "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/timer_cmsdk" ABSOLUTE)
endif()
...
elseif(BUILD_STARTUP)
  if(CMAKE_C_COMPILER_ID STREQUAL "ARMCLANG")
    list(APPEND ALL_SRC_ASM_S "${PLATFORM_DIR}/target/Nuvoton/M2351/armclang/startup_cmsdk_nuvoton_m2351_s.s")
    list(APPEND ALL_SRC_ASM_NS "${PLATFORM_DIR}/target/Nuvoton/M2351/armclang/startup_cmsdk_nuvoton_m2351_ns.s")
    list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/Nuvoton/M2351/armclang/startup_cmsdk_nuvoton_m2351_bl2.s")
  elseif(CMAKE_C_COMPILER_ID STREQUAL "GNUARM")
    list(APPEND ALL_SRC_ASM_S "${PLATFORM_DIR}/target/Nuvoton/M2351/gcc/startup_cmsdk_mps2_an519_s.S")
    list(APPEND ALL_SRC_ASM_NS "${PLATFORM_DIR}/target/Nuvoton/M2351/gcc/startup_cmsdk_mps2_an519_ns.S")
    list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/Nuvoton/M2351/gcc/startup_cmsdk_mps2_an519_bl2.S")
...
elseif(BUILD_TARGET_CFG)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/target_cfg.c")
  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/spm_hal.c")
  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/attest_hal.c")
  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/native_drivers/mpu_armv8m_drv.c")
  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/tfm_platform_system.c")
  embedded_include_directories(PATH "${PLATFORM_DIR}/common" ABSOLUTE)
endif()
...
elseif(BUILD_TARGET_HARDWARE_KEYS)
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/dummy_crypto_keys.c")
endif()
...
elseif(BUILD_TARGET_NV_COUNTERS)
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/dummy_nv_counters.c")
...
elseif(BUILD_CMSIS_DRIVERS)
  #list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/cmsis_drivers/Driver_MPC.c"
  #  "${PLATFORM_DIR}/target/Nuvoton/M2351/cmsis_drivers/Driver_PPC.c")
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/cmsis_drivers/Driver_USART.c")
...
elseif(BUILD_FLASH)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/cmsis_drivers/Driver_Flash.c")
...
elseif(BUILD_BOOT_SEED)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/dummy_boot_seed.c") 
endif()
...
elseif(BUILD_DEVICE_ID)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/dummy_device_id.c")
endif()
